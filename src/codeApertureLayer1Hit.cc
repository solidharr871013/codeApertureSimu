...
//
//
/// \file codeApertureLayer1Hit.cc
/// \brief Implementation of the codeApertureLayer1Hit class
...
G4ThreadLocal G4Allocator<codeApertureLayer1Hit>* codeApertureLayer1HitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

codeApertureLayer1Hit::codeApertureLayer1Hit()
: G4VHit(), 
   fEdep(0),
   fTime(0),
   fScatteringPos(0),
...
//codeApertureLayer1Hit::codeApertureLayer1Hit(G4int layerID)
//: G4VHit(),
...
codeApertureLayer1Hit::codeApertureLayer1Hit(const codeApertureLayer1Hit &right)
: G4VHit(),
  fEdep(right.fEdep),
  fTime(right.fTime),
...
const codeApertureLayer1Hit& codeApertureLayer1Hit::operator=(const codeApertureLayer1Hit &right)
{
  fEdep = right.fEdep;
  fTime = right.fTime;
  fScatteringPos = right.fScatteringPos;
...
G4bool codeApertureLayer1Hit::operator==(const codeApertureLayer1Hit &/*right*/) const
{
  return false;
}
...
void codeApertureLayer1Hit::Draw()
{
...
const std::map<G4String,G4AttDef>* codeApertureLayer1Hit::GetAttDefs() const
{
  G4bool isNew;
  auto store = G4AttDefStore::GetInstance("codeApertureLayer1Hit",isNew);
...
std::vector<G4AttValue>* codeApertureLayer1Hit::CreateAttValues() const
{
  auto values = new std::vector<G4AttValue>;
  
  values
    ->push_back(G4AttValue("HitType","codeApertureLayer1Hit",""));
  values
...
void codeApertureLayer1Hit::Print()
{
  G4cout << "] : "
