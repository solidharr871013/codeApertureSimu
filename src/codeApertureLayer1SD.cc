...
//
//
/// \file codeApertureLayer1SD.cc
/// \brief Implementation of the codeApertureLayer1 class
...
codeApertureLayer1SD::codeApertureLayer1SD(G4String name)
...
codeApertureLayer1SD::~codeApertureLayer1SD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void codeApertureLayer1SD::Initialize(G4HCofThisEvent* hce)
{
  fHitsCollection 
    = new codeApertureLayer1HitsCollection(SensitiveDetectorName,collectionName[0]);
...
G4bool codeApertureLayer1SD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
  ...
  auto hit = new codeApertureLayer1Hit;
