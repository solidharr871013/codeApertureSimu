...
//
//
/// \file codeApertureEventAction.hh
/// \brief Definition of the codeApertureEventAction class

#ifndef codeApertureEventAction_h
#define codeApertureEventAction_h 1

#include "G4UserEventAction.hh"
#include "globals.hh"

class codeApertureRunAction;
...
class codeApertureEventAction : public G4UserEventAction
{
  public:
    codeApertureEventAction(codeApertureRunAction* runAction);
    virtual ~codeApertureEventAction();
  ...
  private:
    ...
    codeApertureRunAction* fRunAction;
    G4double     fEdep;
