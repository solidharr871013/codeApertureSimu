...
//
//
/// \file codeApertureRunAction.hh
/// \brief Definition of the codeApertureRunAction class

#ifndef codeApertureRunAction_h
#define codeApertureRunAction_h 1
...
class codeApertureRunAction : public G4UserRunAction
{
  public:
    codeApertureRunAction();
    virtual ~codeApertureRunAction();
